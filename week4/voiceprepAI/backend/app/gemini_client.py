...
async def connect_to_gemini():
    """
    Creates and returns a websocket connection to Gemini Live API.
    """
    return await websockets.connect(GEMINI_WS_URL)


def get_setup_message():
    """
    Returns the initial setup message sent to Gemini after connecting.
    """
...
async def initialize_gemini(gemini_ws):
    """
    Sends the setup message immediately after connecting.
    """
